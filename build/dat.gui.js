...
var NumberControllerSlider = function (_NumberController) {
  ...
  function NumberControllerSlider(object, property, min, max, step, disableMidi) {
    ...
    if (!disableMidi) {
      _this2.__midiButton = document.createElement('div');
      _this2.__midiButton.style.display = 'none';
      dom.bind(_this2.__midiButton, 'mousedown', onMidiButtonClick);
      dom.bind(_this2.__midiButton, 'touchstart', onMidiButtonClick);
      _this2.__midiButton.innerText = '🎵';
      dom.addClass(_this2.__midiButton, 'slider-midi');
      setMidiDomState();
      detectMidi();
    }
    ...
    function onMidiMessage(e) {
      ...
      if (e.data[1] === _this.__midiControlId) {
        _this.setValue(map(e.data[2], 0, 127, _this.__min, _this.__max));
      }
    }
    ...
    _this2.domElement.appendChild(_this2.__midiButton);
